...
const FeatureSection = () => {
    return (
        <div className='my-30'>
            <p className='text-center font-medium text-indigo-600 dark:text-indigo-400 px-10 py-2 rounded-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 w-max mx-auto'>Features</p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-4 px-6 md:px-16 lg:px-24 xl:px-32">
                {featuresData.map((feature, index) => (
                    <div key={index} className="px-6 py-4 rounded-xl space-y-3 border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800/20 max-w-80 md:max-w-66 hover:scale-105 transition-all duration-100">
