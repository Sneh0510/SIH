        ...
        <div>
            <div className="flex flex-col items-center text-center justify-center mt-20 pb-40">
                ...
                <div className="flex items-center gap-4 mt-8">
                    <button onClick={handleGetStarted} className='flex items-center justify-center gap-2 rounded-full px-5 py-2 text-2xl font-semibold border-[2px] bg-gradient-to-r from-purple-600 to-blue-600 text-white border-none hover:scale-125 transition-all duration-500'>
