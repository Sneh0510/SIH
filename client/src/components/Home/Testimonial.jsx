...
const Testimonial = () => {
  ...
  return (
    <div className="mt-35">
      ...
      <p className='text-center font-medium text-indigo-600 dark:text-indigo-400 mt-20 px-10 py-2 rounded-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 w-max mx-auto'>Testimonials</p>
      <h3 className="text-3xl font-semibold text-center mx-auto mt-4 mb-8">Built for Interns</h3>
