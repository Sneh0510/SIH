...
const QuizForm = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-b from-white to-blue-200 dark:bg-gray-900">
      ...
      <Card className="w-[500px] p-6 mt-5 shadow-xl rounded-2xl">
        <CardContent>
          {/* Step Title */}
