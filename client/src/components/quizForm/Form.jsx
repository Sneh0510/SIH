...
import { Button } from "../ui/Button"; // Assuming these are already styled nicely
import { Input } from "../ui/Input";
import { Card, CardContent } from "../ui/Card";
import { X, Lightbulb, GraduationCap, Code, CalendarDays, FlaskConical } from "lucide-react"; // More relevant Lucide icons
...
const Form = () => {
    ...
    const handleSubmit = () => {
        if (validateStep()) {
            ...
            // Here you would typically send data to a backend or navigate
            // navigate('/dashboard'); 
        }
    };
    ...
    return (
        <motion.div
            ...
            className="w-full max-w-lg mt-8 md:mt-2"
        >
            <Card className="p-6 md:p-8 shadow-2xl dark:shadow-slate-700/50 border border-gray-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-800 h-[550px]">
                                ...
                                <motion.div key="step1" {...stepVariants}>
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-4 min-h-[40px]">
                                        {formData.skills.map((skill, index) => (
                                            <motion.span
                                                key={skill} // Use skill as key for better animation
                    ...
                    <div className="flex justify-between mt-8 pt-4 border-t border-gray-200 dark:border-slate-700">
                        ...
                        {currentStep === steps.length - 1 ? (
                            <Button
                                ...
                                type="button" // Change to button to prevent form submission on enter key
                            >
                                Submit & Find Matches
